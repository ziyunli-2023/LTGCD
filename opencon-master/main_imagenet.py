...
parser = argparse.ArgumentParser(description='orca',formatter_class=argparse.ArgumentDefaultsHelpFormatter)
...
parser.add_argument('--dataset_root', default='/home/datasets/vision/ImageNet/extracted/train', type=str)
...
if __name__ == "__main__":
    ...
    train_label_set = datasets.ImageNetDataset(root=args.dataset_root, anno_file='/home/furkan/Long-Tailed-GCD/src/opencon-master/data/ImageNet100_label_{}_{:.2f}.txt'.format(args.labeled_num, args.labeled_ratio), transform=TransformTwice(transform_train))
    train_unlabel_set = datasets.ImageNetDataset(root=args.dataset_root, anno_file='/home/furkan/Long-Tailed-GCD/src/opencon-master/data/ImageNet100_unlabel_{}_{:.2f}.txt'.format(args.labeled_num, args.labeled_ratio), transform=TransformTwice(transform_train))
    ...
    test_unlabel_set = datasets.ImageNetDataset(root=args.dataset_root, anno_file='/home/furkan/Long-Tailed-GCD/src/opencon-master/data/ImageNet100_unlabel_{}_{:.2f}.txt'.format(args.labeled_num, args.labeled_ratio), transform=transform_test)
